...
namespace vbtournamentreporter
{
    public partial class reporter : Form
    {
        ...
        private void reporter_Load(object sender, EventArgs e)
        {
            ...
            // TODO: Diese Codezeile lädt Daten in die Tabelle "tables.zwischenrunde_gri_view". Sie können sie bei Bedarf verschieben oder entfernen.
            this.zwischenrunde_gri_viewTableAdapter.Fill(this.tables.zwischenrunde_gri_view);
            ...
            // TODO: Diese Codezeile lädt Daten in die Tabelle "tables.vorrunde_gri_view". Sie können sie bei Bedarf verschieben oder entfernen.
            this.vorrunde_gri_viewTableAdapter.Fill(this.tables.vorrunde_gri_view);
        ...
        private void fillByToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.vorrunde_grh_viewTableAdapter.FillBy(this.tables.vorrunde_grh_view);
            }
