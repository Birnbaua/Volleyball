...
public:
    ...
    // calculate result from game results
    QList<teamResult> calculateResults(QList<QStringList> toCalculate)
    {
        QList<teamResult> resultList;

        foreach(QStringList rowToCalculate, toCalculate)
        {
            teamResult m1;
            teamResult m2;
    ...
    // calculate results from vorrunde and zwischenrunde
    QList<teamResult> addResultsVrZw(QList<teamResult> teamResults)
    {
    ...
    // calculate results from kreuzspiele and platzspiele
    QStringList getResultsKrPl(QStringList rowToCalculate)
    {
        teamResult m1;
        teamResult m2;
