...
**
** Version:
** v1.0 ... add background color change for items
**
** v1.1 ... add eventfilter for copy + paste
** 
** v1.2 ... add eventfilter for return and esc key, signals for commit data
**          and close editor
** 
****************************************************************************/

#ifndef DATAMODELS_V1_0
#define DATAMODELS_V1_0
...
signals:
    // key ctrl+c pressed event
    void ctrlCopyKeyEvent();

    // key ctrl+v pressed event
    void ctrlPasteKeyEvent();

    // key enter pressed event
    void enterKeyEvent();

private:
    // color rows by game round
